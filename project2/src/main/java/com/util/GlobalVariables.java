...
public class GlobalVariables {
    ...
    public static final String SCHEDULE_MANAGER_LIST_QUERY = ""; 
    public static final String CONFERENCE_MANAGER_LIST_QUERY = "";
    public static final String JOB_MANAGER_LIST_QUERY = "";
} 
